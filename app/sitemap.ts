...
const staticPages: MetadataRoute.Sitemap = [
  ...
  { url: `${SITE_URL}/notre-demarche`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
  { url: `${SITE_URL}/nos-technologies`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
  { url: `${SITE_URL}/identifier-mon-besoin`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
  { url: `${SITE_URL}/rendez-vous`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
  { url: `${SITE_URL}/contact`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
  { url: `${SITE_URL}/actualites-et-publications`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.8 },
]
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  try {
    ...
    blogUrls = (posts ?? []).map((post: { slug: string }) => ({
      url: `${SITE_URL}/actualites-et-publications/${post.slug}`,
