...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Identifier votre besoin gratuitement — CLBGE, Géomètre-Expert en Guadeloupe",
    description:
    ...
    openGraph: {
      title: "Identifier votre besoin gratuitement — CLBGE",
      description:
      ...
      <section className="bg-background py-12 md:py-20">
        <div className="mx-auto max-w-3xl px-4 md:px-8 lg:px-16">
          <div className="mb-12 text-center">
            <h1 className="mb-4">Identifier votre besoin gratuitement</h1>
