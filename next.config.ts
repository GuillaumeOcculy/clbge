        ...
        headers: [
          {
            ...
            value: [
              ...
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://tally.so https://static.zcal.co https://*.google-analytics.com https://*.googletagmanager.com https://core.sanity-cdn.com",
              "style-src 'self' 'unsafe-inline' https://static.zcal.co",
              "img-src 'self' https://cdn.sanity.io https://static.zcal.co data:",
              "connect-src 'self' https://*.sanity.io wss://*.sanity.io https://sanity-cdn.com https://*.sanity-cdn.com https://*.google-analytics.com https://zcal.co https://*.zcal.co",
              "font-src 'self' data:",
            ].join("; "),
          },
          {
